    ...
    <section className='w-full flex justify-center items-center mt-40'>
      <div className='w-full max-w-[1300px] h-[909px] lg:px-20 md:px-14 px-8 lg:py-32 py-24 rounded-[6rem] bg-gradient-to-b from-[#1E1D1C] to-[#101010] flex flex-col items-center lg:gap-16 md:gap-14 sm:gap-12 gap-10'>
        <div className='text-center'>
          ...
          <h2 className='lg:text-4xl md:text-2xl text-[#7F8188]'>{HERO.description}</h2>
        </div>
        <div className='flex md:gap-6 sm:gap-4 gap-3'>
          <Link href='#work' onClick={(e)=> handleLinkClick(e, '#work')} className='lg:text-base text-sm w-[162px] flex justify-center items-center h-[60px] max-[425px]:w-[120px] max-[425px]:h-[46px] bg-zinc-800/40 hover:bg-zinc-800/50 font-medium rounded-full text-[#adb0b9]' >My work</Link>
